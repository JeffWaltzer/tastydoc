...
#return '' if @document.empty?
  <<-CSS
    ...
    .header {font-size: large; margin-top: 0.25cm;}
    .text {margin-left: 0.25cm;}
    .website {margin-left: 0.25cm;}
    .development .projects {margin-left: 0.5cm; display: list-item; list-style-type: square;}
    .projects .name {margin-left: 0.250cm;font-style:italic; }
    .client {margin-left: 0.5cm;}
    .client .company {font-style:italic}
    .jobs_item {margin-left: 0.75cm; margin-top: 0.2cm}
    .title {padding-top: 0.20cm; font-weight: bold}
    ...
    .responsibilities {margin-left: 0.75cm; display: list-item; list-style-type: circle}
    CSS
